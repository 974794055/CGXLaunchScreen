...
@class CGXLaunchAnimatedImage;
@protocol CGXLaunchAnimatedImageViewDebugDelegate;


//
//  An `CGXLaunchAnimatedImageView` can take an `CGXLaunchAnimatedImage` and plays it automatically when in view hierarchy and stops when removed.
...
//
@interface CGXLaunchAnimatedImageView : UIImageView
...
@property (nonatomic, strong) CGXLaunchAnimatedImage *animatedImage;
